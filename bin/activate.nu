...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/veronikakarelets/Desktop/snake/snakegame_env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/veronikakarelets/Desktop/snake/snakegame_env/bin/deactivate.nu'
